### This RScript Simply Parses The BED TE Annotation output from EDTA
### RAW GFF outputs were transforemd into BED files and can be found on maizegdb.org
### We do this to make reading this output into our shiny app easier
### Last Updated - 03/04/22; Written by Manisha Munasinghe
...
##    to see if the call was made via structure v homology
...
# Supply BED file as argument to script
...
output_full_fname <- paste('/home/brandvai/mmunasin/NAM_EDTA/updated_raw_03.04.22/split_bed_files/attr_split_',NAM_line,sep='')
write.table(bed_data,output_full_fname,col.names=TRUE,quote=FALSE,sep='\t',row.names=F)


## Remove rows w/ certain classification types
